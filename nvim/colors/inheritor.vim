...
call <SID>set_colors("DiffChange"   , s:green, "NONE", "")
...
call <SID>set_colors("LineNr"     , s:darkgray, "NONE"  , "")
...
call <SID>set_colors("PMenu"            , s:fg       , s:darkgray    , "")
call <SID>set_colors("PMenuSel"         , s:fg       , s:darkgray   , "reverse")
call <SID>set_colors("PMenuSbar"        , s:darkgray , s:darkgray   , "")
call <SID>set_colors("PMenuThumb"       , s:lightgray, s:darkgray    , "")
...
call <SID>set_colors("StatusLine"       , "NONE"     , s:fg          , "")
call <SID>set_colors("StatusLineNC"     , "NONE"     , s:fg          , "")
call <SID>set_colors("StatusLineTerm"   , "NONE"     , s:fg          , "")
call <SID>set_colors("StatusLineTermNC" , "NONE"     , s:fg          , "")
...
call <SID>set_colors("Comment", s:darkgray, "", "")
